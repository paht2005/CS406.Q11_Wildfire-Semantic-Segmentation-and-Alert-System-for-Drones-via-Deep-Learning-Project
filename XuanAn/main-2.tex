...
\begin{itemize}
    ...
    \item \textbf{Weaknesses and Mitigations:} 
        \begin{itemize}
            \item \textbf{Memory Overhead:} The deep skip connections can be memory-intensive. To mitigate this, we utilize a lightweight backbone (such as MobileNetV3) to ensure compatibility with edge devices like the NVIDIA Jetson Nano.
        \end{itemize}
\end{itemize}
...
\begin{table}[H]
\centering
\caption{Comparative Performance Metrics on FLAME Test Set}
